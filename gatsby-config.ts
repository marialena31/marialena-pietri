  ...
  plugins: [
    ...
    `gatsby-plugin-sitemap`,
    {
      ...
      options: {
        ...
        directives: {
          "default-src": "'self'",
          "script-src": "'self' 'nonce-sha256-egpbluqkD8NT0bY3bWy7raM9tRIMkfUWboq0Y8KqsFk=' https://www.google.com/recaptcha/ https://www.gstatic.com/recaptcha/ https://*.netlify.app https://*.netlify.com",
          "script-src-elem": "'self' 'nonce-sha256-v1oYH69RcooFs6F5XhMTzHiWlftYwnuQHDxIz0suNeo=' https://*.netlify.app https://*.netlify.com",
          "style-src": "'self' 'nonce-sha256-Ext49gspPHCvQnkZPoRZMwmNL03mSa1YCzbtXrbKjec=' https://fonts.googleapis.com https://*.netlify.app https://*.netlify.com",
